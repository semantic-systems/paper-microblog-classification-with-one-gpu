        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for id_, row in enumerate(f):
                ...
                yield id_, {
                    ...
                    "trust": int(data[12]),
                    "label": [int(data[2]), int(data[3]), int(data[4]), int(data[5]), int(data[6]), int(data[7]),
                              int(data[8]), int(data[9]), int(data[10]), int(data[11]), int(data[12])]
                }